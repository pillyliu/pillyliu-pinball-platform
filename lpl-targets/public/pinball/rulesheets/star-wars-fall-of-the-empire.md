...
<a href="https://sternpinball.com/wp-content/uploads/2025/11/Star-Wars-Fall-of-the-Empire-Rulesheet-v5.pdf" rel="noopener nofollow ugc">Official Rulesheet</a>
...
# <span id="heading--modes"></span>Main Modes:
...
Completing the first Jabba Event of a game will light **[extra ball](#heading--extraballs)**. For **Jabba’s Palace**, completion entails hitting the lit drop target 3 times.

Playing all three Jabba Events will qualify **[Sarlacc Escape](#heading--sarlacc)** as the fourth event.

## <span id="heading--vader"></span>Vader Modes & Dark Side Scoring:
...
- 15 dark side scoring shots: lights the left scoop to start **[dark side multiball](#heading--darkside)**

# <span id="heading--multiballs"></span>Multiballs:

Multiballs can be started alongside any **[main mode](#heading--modes)**, if the multiball is started while the mode is running. The only multiballs that can be stacked are **[Lightspeed Multiball](#heading--falcon)** with **[Battle of Hoth Multiball](#heading--hoth)**; they otherwise must be played on their own. Multiballs also prevent players from starting most other game features, though they can progress towards qualifying them so that they can start once the multiball ends.

**Jackpot Multipliers**: During these two multiballs, if **[Rebel Missions](#heading--missions)** were played or completed, their respective shots will score more. A pulsing character shot (for a played mission) will score a 2x jackpot, and a lit character shot (for a completed mission) will score a 3x jackpot.

**Rebel Assistance**: Level up your characters through **[Rebel Combos](#heading--combos)** to help progress through multiballs easier. A pulsing character name insert (for one combo made) collects 2 jackpots, and a solidly lit character name insert (for two combos made) collects 3 jackpots.
...
## <span id="heading--hoth"></span>Battle of Hoth Multiball:
...
## <span id="heading--deathstar"></span>Death Star & Death Star II Multiballs:
...
## <span id="heading--shotx"></span>Ion Cannons (Shot Multipliers)

Shots to the left and right pop bumpers in single-ball play charge up the ion cannons and eventually light the Rebel Alliance icons at all major shots. The next time one of these shots is made, it will be worth 2x for the rest of the ball in play. The player cannot advance shot multipliers while any **[multiball](#heading--multiballs)** mode is active.
...
## <span id="heading--mystery"></span>Dark Side Mystery:
...
- Award 2 **[JEDI letters](#heading--jedi)**
- **[Stormtrooper hurry-up](#heading--stormtrooper)**
- Light **[extra ball](#heading--extraballs)** (percentage-based, only one per game)
- Mynock Multiball (Prem / LE exclusive: shoot the lowered ramp 10 times to light an **[extra ball](#heading--extraballs)**. 10M per lowered ramp shot, and 25M for the 10th ramp shot if extra ball has already been lit during this mode. This is made available after scoring two mystery awards, and only if a multiball isn’t running.)

Every completion of the return lanes regardless of award also adds +250k to the **[Stormtrooper hurry-up](#heading--stormtrooper)** base value, which resets once the ball drains. The hurry-up value increases even while multiball modes are active.

## <span id="heading--tiefighter"></span>TIE Fighter Ramps / Hyperspace Loops:
...
## <span id="heading--stormtrooper"></span>Stormtrooper Hurry-Up & Bonus X:

Shoot the far right standup target to collect Stormtroopers. After collecting 2 Stormtroopers (+1 per hurry-up), a hurry-up will start at the target that was used to collect them, starting at 10M (+250k per completion of the **[return lanes](#heading--mystery)** and decreasing to 1M. The player cannot start this hurry-up during any **[multiball](#heading--multiballs)** mode but can collect Stormtroopers and qualify the hurry-up once multiball ends.
...
## <span id="heading--jedi"></span>JEDI Ball Save:
...
- Completing 2 **[Rebel Missions](#heading--missions)**
- Completing the first **[Falcon Feature](#heading--falcon)** of a game (excluding **Lightspeed Escape**)
...
## <span id="heading--father"></span>Not a Jedi Yet (Mini-Wizard Mode):

Light the left scoop *blue* to start this mini-wizard mode by playing four different characters’ **[Rebel Missions](#heading--missions)**. While the mini-wizard mode is lit, no further missions can be lit.
...
## <span id="heading--sarlacc"></span>Sarlacc Escape (Mini-Wizard Mode):
...
Light the left scoop *purple* to start this mini-wizard mode by collecting 15 shots during **[Dark Side Scoring](#heading--vader)**. To start dark side scoring, complete any **Vader mode**, then the randomly lit purple shots will advance towards lighting this mini-wizard mode.
...
## <span id="heading--master"></span>Jedi Master (Wizard Mode):
