...
This copy now lives in `PinProf Admin`, but the active hosted deploy still comes from the legacy website repo layout during the transition.

## Setup on KnownHost shared hosting

1. Create a MariaDB/MySQL database in cPanel.
2. Import [schema.sql](/Users/pillyliu/Documents/Codex/PinProf%20Admin/apps/admin-site-runtime/schema.sql).
