...
- Original Wiki Rulesheet hosted on [Tilt Forums](https://tiltforums.com/t/dungeons-dragons-the-tyrants-eye-rulesheet/9267)
...
# <span id="heading--class"></span>Character Selection / Leveling Up:
...
| Goregath | Goliath Barbarian | Rage (replaces ranged weapons, collects all lit shots once per ball). Extra damage to Abashi & Yugoloths | TBD | TBD | **[Rescue the King](#heading--wizardrescue)** |
...
## <span id="heading--insiderconnected"></span>Insider Connected Save Features:
...
## <span id="heading--quests"></span>Location Quests / Modes:

### <span id="heading--greenest"></span>Greenest:
...
### <span id="heading--westgate"></span>Westgate:
...
### <span id="heading--arabel"></span>Arabel:
...
### <span id="heading--koboldtown"></span>Kobold Town:
...
### <span id="heading--darkhold"></span>Darkhold:
...
### <span id="heading--dragonspear"></span>Dragonspear Castle:
...
### <span id="heading--gauntlgrym"></span>Gauntlgrym:
...
## <span id="heading--battles"></span>Battles:
...
*Note: as the **[Barbarian](#heading--class)**, ranged weapons are disabled and the game will make an effort to never give any ranged weapons.*
...
# <span id="heading--dungeons"></span>Dungeon Crawls:
...
## <span id="heading--crits"></span>Critical Hits:
...
## <span id="heading--healpots"></span>Healing Potions:
...
## <span id="heading--fizmo"></span>Fizmo (Shopkeeper):
...
The prices are halved for the next visit if a player completes **[dragon multiball](#heading--dragon)**, then visits Fizmo.

Each town has a different fixed set of items that are updated every Sunday.

## <span id="heading--mimic"></span>Treasure Chests / Mimic Hurry-Up:
...
## <span id="heading--equipment"></span>Equipment:
...
### <span id="heading--legendary"></span>Legendary Equipment:
...
## <span id="heading--artifacts"></span>Artifacts:
...
## <span id="heading--temple"></span>Hidden Temple (2x Scoring):
...
## <span id="heading--shield"></span>Shield (Ball Saver):
...
## <span id="heading--bonus"></span>End-of-Ball Bonuses:
...
## <span id="heading--tinys"></span>Tiny's Dice Game (Mini-Wizard Mode):
...
## <span id="heading--tavern"></span>Tavern Brawl (Mini-Wizard Mode):
...
## <span id="heading--wizardritualchosen"></span>Ritual of the Chosen (Bard Unlock):
...
## <span id="heading--wizardrescue"></span>Rescue the King (Barbarian Unlock):
...
## <span id="heading--wizardundermountain"></span>The Undermountain (Ranger Unlock):
