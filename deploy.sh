...
refresh_pinprof_admin_shared_payload() {
  echo "Skipping legacy PinProf Admin shared/pinball refresh."
  echo "Shared OPDB/catalog data is now generated by this repo's sync pipeline to preserve additive OPDB fields."
}
