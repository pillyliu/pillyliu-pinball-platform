...
<ul>
	...
	<li><i>CO2:</i> register a total of 40 spins on the spinner within about 40 seconds. Every 10 spins, you'll find an Item: items score 10,000,000, then 20,000,000, then 30,000,000, then 40,000,000. If you collect all 4 items, you receive a bonus that seems to be equal to 20,000,000 points plus an additional 1,000,000 for every non-spinner switch hit during the mode.</li>
...
<p>If standard multiball ends with no jackpots scored, the Rocket ramp will be lit to restart multiball for 15 seconds.</p>
...
<ul>
	<li>start a game</li>
	<li>shoot the Moon ramp when it is lit yellow, which can be at the beginning of each ball, at the beginning of each game, or never</li>
	<li>receive a Blastoff letter from a mystery award</li>
...
<p>At the start of the game, you will be asked to choose Novice game or Regular game. On Novice game, you get one ball with unlimited ball save for 2 minutes, and the game ends when that ball drains after the ball save expires. Regular game is conventional play (usually three or five balls).</p>
...
<p>The free Blastoff letter on game start and the free Blastoff letter for the first Moon ramp shot during a ball or game can both be independently disabled.</p>
...
<table>
	...
	<tr>
		...
		<td>...shooting the Rocket ramp a couple times to make progress toward multiball, or complete the Moon targets and collect a Shoot the Moon hurry-up on the right ramp if you happen to have already collected some of the Moon letters in order.</td>
	</tr>
	<tr>
		<td>100,000,000 points</td>
		<td>...starting and playing pretty much any main mode.</td>
	</tr>
	<tr>
		<td>200,000,000 points</td>
		<td>...playing the regular 3-ball Rocket Multiball with the goal of collecting a super jackpot.</td>
	</tr>
	<tr>
		<td>500,000,000 points</td>
		<td>...scoring enough orbits to reach and play Power Up or Power Down, or play Manual Burn main mode with the goal of intentionally overcorrecting whenever possible to continue making high value shots.</td>
	</tr>
	<tr>
		<td>1,000,000,000 points or more</td>
		<td>...starting 13-ball multiball and earning a Super 13 Jackpot if you are close to spelling Blastoff, or playing through enough modes or orbit awards to reach Master Alarm or Splashdown wizard modes.</td>
	</tr>
</table>
</div>
