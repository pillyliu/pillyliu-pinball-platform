...
source: "https://pinballprimer.github.io/addams_G4ODR.html"
provider: "pp"
---
<small class="rulesheet-attribution">Source: Pinball Primer | Original page: <a href="https://pinballprimer.github.io/addams_G4ODR.html">link</a> | Preserve source attribution and any author/site rights notes from the original page. | Reformatted for readability and mobile use.</small>
...
<p>The below picture of The Addams Family's playfield was taken from the VPX recreation by Sliderpoint.</p>

<img src="https://pinballprimer.github.io/addams.jpg" alt="The Addams Family playfield" class="center" width="400" height="auto">
...
<p>Shooting the electric chair scoop in the center of the playfield or the Swamp kickout in the lower right awards a Mansion room when lit. (If there is no yellow light next to the electric chair, shoot either ramp to qualify a Mansion room. The center Bear Kick ramp is almost always easiest, and can sometimes be backhanded.) The award will be whichever mansion room is flashing, which rotates with hits to the pop bumpers. The mansion rooms are:</p>
<ul>
...
<table>
	...
	<tr>
		...
		<td>...collecting any mansion room.</td>
	</tr>
	<tr>
		<td>10,000,000 points</td>
		<td>...earning 1-3 mansion rooms, which will also build your end of ball bonus along the way if you shoot the Bear Kick ramp to relight the electric chair.</td>
	</tr>
	<tr>
		<td>25,000,000 points</td>
		<td>...playing a multiball, earning 3-4 mansion rooms, or dialing in the side ramp to earn its millions-plus and a possible eventual Thing award.</td>
	</tr>
	<tr>
		<td>50,000,000 points</td>
		<td>...combining a multiball with a couple of the more valuable Mansion modes, like Mamushka, Hit Cousin It, or (if magnets are disabled) Seance.</td>
	</tr>
	<tr>
		<td>100,000,000 points or more</td>
		<td>...earning as many super jackpots as possible from multiball, or dialing in the Bear Kick ramp -> electric chair combo to get to Tour the Mansion as quickly as possible.</td>
	</tr>
</table>
</div>
