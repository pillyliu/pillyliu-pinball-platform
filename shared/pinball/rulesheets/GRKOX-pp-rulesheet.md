---
title: "Jack•Bot"
source: "https://pinballprimer.github.io/jackbot_GRKOX.html"
provider: "pp"
---
<small class="rulesheet-attribution">Source: Pinball Primer | Original page: <a href="https://pinballprimer.github.io/jackbot_GRKOX.html">link</a> | Preserve source attribution and any author/site rights notes from the original page. | Reformatted for readability and mobile use.</small>
...
<img src="https://pinballprimer.github.io/jackbot.jpg" alt="JackBot playfield. Taken from VPX by bord et al." class="center" width="400" height="auto">
...
<p>A frequent strategy on JackBot is to ignore the skill short entirely and short plunge. If a ball drains without hitting 3 different switches on the playfield, it will always be returned to you, since the game will not consider the ball as "in play". High level players will frequently short plunge to get the ball on a flipper without activating the vortex skill shot or any bumpers so that they can line up a shot to the Game Saucer or Visor targets. If you're precise with your plunging, this is much safer than trying for a skill shot and putting the ball into the pop bumpers. A very good short plunge that hits <i>no</i> switches on the way down can be used to take free shots at the visor's column targets with no risk of an immediate rebound drain since you still haven't met the 3 switch quota yet.</p>
...
<ul>
	...
	<li>Bucket of Water (sometimes called a "No Bomb"): is held onto until you need it or until Casino Run ends. Defuses one bomb.</li>
	<li>Bomb: ends the run and forfeits your entire bank, unless you either punch it away by cheating, have a previously earned bucket of water, or spin a bucket of water at the same time as the Bomb.</li>
	...
	<li>Cow: awards an instant Special.</li>
</ul>
