...
source: "https://pinballprimer.github.io/afm_G4do5.html"
provider: "pp"
---
<small class="rulesheet-attribution">Source: Pinball Primer | Original page: <a href="https://pinballprimer.github.io/afm_G4do5.html">link</a> | Preserve source attribution and any author/site rights notes from the original page. | Reformatted for readability and mobile use.</small>

<div class="pinball-rulesheet remote-rulesheet primer-rulesheet">
<h1>Attack From Mars (Bally Williams, 1995)</h1>

<p>Not to be confused with Revenge from Mars (Bally Williams, 1999).</p>

<h2>Quick strategy synopsis</h2>

<p>For quick points such as in a tournament setting, determine how safe it is to shoot the saucer (both the Forcefield targets and the targets/holes behind). If these are safe, focus on saucers as a primary strategy. If the saucer is dangerous, focus on whichever ramps and orbits still have flashing lights to work toward multiball and Total Annihilation. </p>

<p>The below picture of Attack From Mars' playfield was taken from the VPX recreation by G5k.</p>

<img src="https://pinballprimer.github.io/afm.jpg" alt="Attack From Mars playfield" class="center" width="400" height="auto">
...
<p>The Forcefield is a motorized bank of 3 standup targets at the top center of the table that can retract under the playfield itself. There are 3 ways to destroy the Forcefield and start an Attack Wave round: hit all 3 standup targets that make up the Forcefield itself, hit any Forcefield target with the Super Skill Shot, or earn the Start Attack Wave award from the Stroke of Luck mystery. The Forcefield has easy or hard settings: on easy settings, you need to hit any target in the bank a total of 3 times, while on hard settings, you must hit each target once. During an Attack Wave, the goal is to hit the two standup targets and/or lone drop target within the saucer structure itself. After hitting those targets enough times, the drop target will stay down, opening the Destroy Saucer hole.<br>The first saucer scores 50,000,000 points per target hit, requires 3 hits to expose the Destroy hole, and awards 200,000,000 points for destroying the saucer. Subsequent saucers up to and including the 5th score 10,000,000 more points per target hit, require 3 additional hits to destroy, and give 100,000,000 additional points for destroying. The country being attacked is purely cosmetic: the length and scoring of each saucer round is based solely on how many saucers have been completed.</p>
...
<ul>
	...
	<li>Award Lock</li>
	<li>Multiball (typically only during the final ball of the game if the player hasn't played standard multiball yet, or rarely if 2 balls are locked/multiball is ready at the lock lane)</li>
	<li>Light Martian Attack</li>
	<li>1 Martian Bomb</li>
	<li>Strobe Multiball</li>
	<li>Video Mode</li>
	<li>Sneak Attack</li>
	<li>Light Extra Ball (typically only seen on the last ball of the game, if the player's first balls were very short in length); collected at the Stroke of Luck scoop</li>
</ul>
...
<p>The first Attack Wave saucer can require anywhere from 1 to 5 hits before the center hole is available to destroy the saucer; default is 3. Subsequent saucers always require 3 more hits than the previous.</p>
...
<table>
	...
	<tr>
		...
		<td>...making a Super Skill Shot, starting an Attack Wave, or making 2-3 shots toward a ramp or orbit that has not yet been completed toward Total Annihilation.</td>
	<tr>
	<tr>
		<td>200,000,000 points</td>
		<td>...playing standard multiball, or completing one or more of the four ramps/orbits and collecting the corresponding hurry-up at the Saucer/Forcefield.</td>
	</tr>
	<tr>
		<td>500,000,000 points</td>
		<td>...completing an Attack Wave saucer, or starting standard multiball and scoring a Super Jackpot.</td>
	</tr>
	<tr>
		<td>2,000,000,000 points</td>
		<td>...playing Total Annihilation, or if you've already completed 4-5 saucers, try to Conquer Mars.</td>
	</tr>
	<tr>
		<td>5,000,000,000 points or more</td>
		<td>...focusing on Total Annihilation- playing it several times if necessary- or focusing on Conquer Mars, or even Rule the Universe if you're close to it. </td>
	</tr>
</table>
</div>
