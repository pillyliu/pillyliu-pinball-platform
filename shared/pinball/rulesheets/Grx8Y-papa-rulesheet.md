...
source: "https://pinball.org/rules/getaway.html"
provider: "papa"
---
<small class="rulesheet-attribution">Source: PAPA / pinball.org rulesheet archive | Original page: <a href="https://pinball.org/rules/getaway.html">link</a> | Preserve source attribution and any author/site rights notes from the original page. | Reformatted for readability and mobile use.</small>

<div class="pinball-rulesheet remote-rulesheet legacy-rulesheet">
<SPAN CLASS="bodySmall">
Sigma's Guide to High Speed II: The Getaway<br>
Version of 3/3/94
</SPAN>
<p>
...
<p>
<span class="bodyTitle">Objective Of The Game</span><P>
...
<p>
<span class="bodyTitle">Important Things</span>
<P>
...
<p>
<dl>
<dt>Flippers <dd> There are three flippers, the usual two lower ones, and an upper
...
(Whirlwind, for example).  (Note: the newest revisions of the machine <u>do</u>
offer a two-stage control mechanism for these flippers, and also raise the
upper flipper automatically as part of a ball search.)</dd>
<dt>Plunger/Shifter <dd> This is an up/down shifter in place of the usual spring
plunger.  It's an autolauncher, and where the ball lands in play depends
entirely on its strength and the angle of the playfield.  It <u>should</u> go
...
Outlane.</dd>
<dt>Left Loop <dd> This is a loop hit from the upper right flipper.  It loops around
to the same flipper.  There is a Loop Champion for this shot.</dd>
<dt>Jet Bumpers <dd> There are three Jet Bumpers at the top center of the playfield,
...
all simultaneous players.</dd>
<dt>Stoplights <dd> There are three rows of sensors, representing traffic lights.
...
other two rows lie along the entrance to the Left Loop.</dd>
<dt>Supercharger <dd> This is a large triangular loop mounted above the Jet Bumpers.
...
Inlane.</dd>
<dt>Left Orbit <dd> This is the long shot up the left side of the machine and around
to the upper right flipper.</dd>
<dt>Right Orbit <dd> This is the long shot up the right side of the machine and
around and down the left side.  It is essentially the reverse of the Left
Orbit, and the same non-directional sensors are used to detect both shots.</dd>
<dt>Tunnel <dd> This is the saucer in a short lane just to the left of the Right
...
kicks out to the right and feeds to the upper right flipper.</dd>
<dt>1-2-3 Targets <dd> These are two rows of sensors, one row above each outlane,
...
also increase the Supercharger Boost value by 1M for each hit.</dd>
<dt>Left Outlane <dd> There is no rubber on the lane divider on this side.  There is
a gaping metallic scoop on this outlane, and a Kickback which should kick
the ball into the Tunnel.  There is a Special light here.</dd>
<dt>Kickback <dd> This is just an excuse to have a gaping left drain.  Normal
machine settings do not relight the Kickback at the beginning of each ball.
Hit the 1-2-3 targets to do this.</dd>
<dt>Left Inlane <dd> Going through this lane lights the Freeway on the Right Orbit.
...
Freeway is still lit (in fact, the grace period may be even longer).</dd>
<dt>Slingshots <dd> These are the usual two above the flippers.</dd>
<dt>Right Inlane <dd> Going through this lane lights the Freeway on the Left Orbit.
...
award only one).</dd>
<dt>Right Outlane <dd> There is a thin metal lane divider on this side.  There is a
Special light in the Outlane.</dd>
<dt>Back Ramp <dd> This is in the far back right corner of the game, and it comes
...
the right side of the machine.</dd>
<dt>Hideout <dd> This is the small house on the right side of the game, above the
...
auto-plunger.</dd>
<dt>Free Ride <dd> There isn't really a playfield feature for this, except the large
...
(Except for a bug on some machines...)</dd>
</dl>
<p>
<span class="bodyTitle">Gears</span><P>
...
<p>
<ul>
<li> 1st Gear - 3 Million
<li> 2nd Gear - Hold Bonus
<li> 3rd Gear - Light Video Mode
<li> 4th Gear - Supercharger Mode
<li> 5th Gear - Light Redline Mania
</ul>
<p>
...
<p>
<span class="bodyTitle">Left Loop</span><P>
...
<p>
<span class="bodyTitle">Freeway</span><P>
...
light it afterwards.
<p>
<span class="bodyTitle">Stoplights</span><P>
...
shoot the Lock.
<p>
<span class="bodyTitle">Supercharger</span><P>
...
<p>
On some machines, the Supercharger does <u>not</u> stop at 25M during Supercharger
Mode.  Go figure.
<p>
...
<p>
<span class="bodyTitle">Tunnel</span><P>
...
<p>
<span class="bodyTitle">Video Mode</span><P>
...
<p>
<span class="bodyTitle">Multiball</span><P>
...
<p>
"Dispatch, this is Car 504.  Suspect ran a red light, over."<br>
...
<p>
"Dispatch, this is 504.  Suspect got away."<br>
"He WHAT?!"<br>
"HE - GOT - AWAY!!"
<p>
"504, you are authorized to use lethal force."<br>
...
<p>
"Where'd he go?"<br>
"He went in the tunnel--"<br>
"HEY!  LOOK OUT!!"<br>
&lt;&lt;crash&gt;&gt;<br>
"Chopper, you out there?"<br>
<p>
<span class="bodyTitle">Redline Mania</span><P>
...
<ul>
<li> 10M
<li> Extra Ball is Lit
<li> Freeway at 5M
<li> All Targets 500K
<li> Kickback is Lit
<li> Jackpot is Lit
<li> Super Jackpot at 100M
<li> Multiball
</ul>
<p>
...
<p>
<span class="bodyTitle">Secret Mania</span><P>
...
<p>
<span class="bodyTitle">Tips, Tricks, Strategies</span><P>
...
<p>
<span class="bodyTitle">Quotes</span><P>
<ul>
<li> "Dispatch, run a make on license plate KINGPIN."
<li> "Choppers, can you see the suspect?"
<li> "Roger, dispatch, I see him."
<li> "Choppers, head to 504's location."
<li> "What kind of car IS that, anyway?!"
<li> "Alright, up against the car, buddy.  You have the right to remain silent,
...
<li> Removed old ftp information for the Pinball Archive.
</ul>
</div>
