...
source: "https://pinballprimer.github.io/brideofpinbot_GRpee.html"
provider: "pp"
---
<small class="rulesheet-attribution">Source: Pinball Primer | Original page: <a href="https://pinballprimer.github.io/brideofpinbot_GRpee.html">link</a> | Preserve source attribution and any author/site rights notes from the original page. | Reformatted for readability and mobile use.</small>

<div class="pinball-rulesheet remote-rulesheet primer-rulesheet">
<h1>The Machine: Bride of PinBot (Bally Williams, 1991)</h1>

<p>Not to be confused with its prequel PinBot (Williams, 1986) or its sequel JackBot (Bally Williams, 1995).</p>
...
<p>The below picture of Bride of PinBot's playfield was taken from the VPX recreation by VPin Workshop.</p>

<img src="https://pinballprimer.github.io/brideofPinBot.jpg" alt="Bride of PinBot playfield" class="center" width="400" height="auto">
...
<p>When the Billion Shot is lit, make the center ramp within 12 seconds to score 1,000,000,000 points and have your score put into the Billionaires Club. (Collecting the Billion Shot makes your score ineligible for the conventional Grand Champion award.) In competition play, the time limit on the Billion Shot will usually be set to 1 second, which makes the shot impossible. This modification makes Bride of PinBot viable for tournament play, but means some Big Wheel spins are complete duds.<br>Whenever there are 2 balls in play, all scoring on the playfield is doubled, with the exception of the Big Wheel's awards, the left side lane's Power Charge (explained below), and the Jackpot.<br>If multiball ended before starting Metamorphosis, you will only need to lock both balls for Optical Link (Face 2) to restart multiball, but if the Metamorphosis occurred before single ball play resumed, the next multiball will require starting the whole sequence over from Face 1, even if the Big Wheel was never spun.</p>
...
<p>The left loop is shot just to the right of the left ramp, and comes out of the left lane entrance. Left loops score 25,000 - 50,000 - 100,000 - 500,000 plus light extra ball. The last award in that sequence can only be collected once per ball in play.</p>

<p>The center "loop" is the Heartbeat ramp, which eventually puts the ball in the right in lane. The center ramp is slightly less risky from the left flipper, but the repeated looping is usually only possible with the right. Heartbeat ramps score 50,000 - 100,000 - 1,000,000 points. If you're really good at the center loop shot, this unlimited Million is arguably the best source of scoring in the game that isn't the Big Wheel.</p>
...
<p>Base bonus is advanced by pop bumpers, slingshots, and in/out lanes. Loop bonus is equal to 10,000 points per loop made on the current ball as well. Bonus multiplier is advanced by hitting all three of the green standup targets in the lower playfield. The full bonus calculation is (base bonus + loop bonus) times bonus multiplier. There is no meaningful limit to the base bonus or bonus multiplier. The bonus multiplier can be increased as high as 255x; if it is advanced further, it rolls back to 0x, and draining with 0x is considered the same as draining at 1x. When the bonus multiplier exceeds 100x, the game will stop showing the hundreds digit during some animations, but it should still count correctly. This is all rather absurd discussion, as the vast majority of balls on Bride of PinBot end with 10x bonus or less. Bonus and bonus multiplier cannot be carried from ball to ball.</p>
