---
title: "Scared Stiff Rulesheet"
source: "http://pilot.msu.edu/~mccannr1"
source_updated_at: null
---

<small class="rulesheet-attribution">Sources: <a href="https://www.ipdb.org/rulesheets/3915/SCARED.HTM">IPDB hosted rulesheet</a> (Avenue source URL) and local frontmatter source reference <code>http://pilot.msu.edu/~mccannr1</code>. | Attribution: Bob McCann & Dan Wilson (v2.2 per source page). | IPDB hosts the page; source text also includes author maintenance/permission notes. Reformatted for readability and mobile use.</small>
...
- [II. Playfield Layout](#heading--playfield)
- [III. Six Tales of Terror](#heading--tales)
- [IV. Spin Spider](#heading--spinspider)
- [V. Misc Stuff](#heading--misc)
- [VI. End Stuff](#heading--end)
...
This rulesheet is maintained by Bob McCann and shouldn't be changed without his permission. The latest version can be obtained from http://pilot.msu.edu/~mccannr1
