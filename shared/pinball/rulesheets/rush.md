...
- [Other Features](#heading--other)
  ...
  - [Upper Loop & Bonus X](#heading--loops)
...
<tbody>
<tr>
<td><img src="https://sternpinball.com/wp-content/uploads/2022/01/Rush-Premium-Playfield-hnad-scaled-918x1536.webp" role="presentation" width="298" height="500" /></td>
<td><img src="https://sternpinball.com/wp-content/uploads/2022/01/Rush-Pro-Playfield-afda-scaled-905x1536.webp" role="presentation" width="294" height="500" /></td>
</tr>
</tbody>
</table>
...
## <span id="heading--upgrades"></span>Time Machine Upgrades - Getting to 2112:
...
## <span id="heading--planets"></span>Records & Planet Modes:
...
## <span id="heading--multiballs"></span>Multiball Modes:
...
### <span id="heading--timemachinemb"></span>Time Machine Multiballs:

Power up the Time Machine portal ramp by shooting the ramp that passes through it 3 times +6 per multiball -1 per **[decade](#heading--years)**, then shoot it once more to start one of its three multiball modes, each with their own rules.

The dead end shot changes which multiball is lit. Each multiball is played with 2 balls, though upgrading the time machine by collecting **[years](#heading--upgrades)** can add more balls to these modes.
...
## <span id="heading--other"></span>Other Features:

### <span id="heading--instruments"></span>Collecting & Activating Instruments:
...
- Bass - **Combos** score 2x and can be collected during multiball modes. On default settings, combos do not qualify **[albums](#heading--albums)** during multiball, just score points that are added into the **Combo Jackpot**.
...
### <span id="heading--drumclock"></span>Drum Clock, Drum Bonus & Clock Bonus:
...
### <span id="heading--loops"></span>Upper Loop & Bonus X:

Shooting the upper loop typically sends the ball slowly back to the upper flipper. If **[combo super jackpot](#heading--combojp)** is lit, repeated shots to the upper loop (while the arrow at its entrance is flashing white) score increasing amounts of points - 500k + 100k per shot, up to 1M. These values are multiplied by **[shot multipliers](#heading--planets)** - the maximum loop value, with 2x on the upper loop, is 6M per shot.
...
### <span id="heading--combojp"></span>Combo Jackpot & Albums:
...
|----|----|----|----|----|
| Rush | Left Orbit | Inner Loop | Side Ramp | **[Working Man](#heading--planets)** |
...
| Vapor Trails | Dead End / VUK | Left Orbit | Side Ramp | **[One Little Victory](#heading--victory)** |
| Power Windows | Spinner | Inner Loop | Inner Loop | **[The Big Money](#heading--planets)** |
| Permanent Waves | Spinner | Inner Loop | Side Ramp | **[Freewill](#heading--freewillmb)**, **[The Spirit of Radio](#heading--planets)** |
| Clockwork Angels | Spinner | Side Ramp | Dead End / VUK | **[Headlong Flight](#heading--headlongmb)** |
| Moving Pictures | Right Ramp | Spinner | Inner Loop | **[Limelight](#heading--planets)**, **[Red Barchetta](#heading--timemachinemb)**, **[Tom Sawyer](#heading--planets)** |
| Signals | Right Ramp | Spinner | Side Ramp | **[Subdivisions](#heading--timemachinemb)** |
...
### <span id="heading--weapon"></span>The Weapon:
...
### <span id="heading--ramps"></span>Ramp Count-Up:
...
Getting to **[2092](#heading--years)** causes all ramp shots for the remainder of the ball to count double towards these awards.

### <span id="heading--bastille"></span>RUSH Targets & Bastille Day Hurry-Up:
...
### <span id="heading--mystery"></span>Roll the Bones Mystery:
...
### <span id="heading--extraball"></span>Extra Balls:
...
- Collect 5 **[albums](#heading--albums)**
...
### <span id="heading--funwithbonus"></span>End-of-Ball Bonus:
...
### <span id="heading--cygnus1"></span>Cygnus X-1 Book 1 - The Voyage:
...
- Blue Planet jackpots = 1M + 2M x total **[Far Cry MB](#heading--farcrymb)** Super Jackpots + 3M x total **[One Little Victory Laps](#heading--victory)** Super Jackpots
...
### <span id="heading--cygnus2"></span>Cygnus X-1 Book 2 - Hemispheres:
...
### <span id="heading--2112"></span>2112:
